...
Terraform module which creates [PrivateLink VPC Endpoint](https://www.alibabacloud.com/help/en/privatelink/) resources on Alibaba Cloud. This module provides the ability to create and manage PrivateLink VPC Endpoints, enabling VPC resources to securely access endpoint services through private network connections. It supports multi-zone deployment, security group association, bandwidth control, and policy document configuration.
...
* [Complete Example](https://github.com/alibabacloud-automation/terraform-alicloud-private-link-vpc-endpoint/tree/main/examples/complete)
